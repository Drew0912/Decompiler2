...
def OP_19(arg1: uint8, arg2: uint16):
    ...
    assert isinstance(arg1, uint8)
    assert isinstance(arg2, uint16)
    _gScena.handleOpCode(0x19, arg1, arg2)
...
def CreateThread(chrId: int, threadId: int, func: str, scriptId: int, *args):
    ...
    assert isinstance(scriptId, int)
    return _gScena.handleOpCode(0x1E, chrId, threadId, func, scriptId, *args)

def OP_1E(chrId: int, threadId: int, func: str, scriptId: int, *args):
    # 0x1E
    assert isinstance(chrId, int)
    assert isinstance(threadId, int)
    assert isinstance(func, str)
...
def OP_20(arg1: uint8, arg2: tuple | list, arg3: tuple | list, arg4: tuple | list, arg5: tuple | list, arg6: uint8):
    # 0x20
    assert isinstance(arg1, uint8)
    assert isinstance(arg2, tuple | list)
    assert isinstance(arg3, tuple | list)
    assert isinstance(arg4, tuple | list)
    assert isinstance(arg5, tuple | list)
    assert isinstance(arg6, uint8)
    _gScena.handleOpCode(0x20, arg1, arg2, arg3, arg4, arg5, arg6)

def OP_21(arg1: uint8, arg2: uint8):
    # 0x21
    assert isinstance(arg1, uint8)
    assert isinstance(arg2, uint8)
    _gScena.handleOpCode(0x21, arg1, arg2)
...
def OP_2A(arg1: int, arg2: int, *args):
    # 0x2A
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    return _gScena.handleOpCode(0x2A, arg1, arg2, *args)
...
def OP_34(arg1: uint8, arg2: float32, arg3: float32, arg4: float32, arg5: float32, arg6: uint16):
    # 0x34
    assert isinstance(arg1, uint8)
...
def OP_3E(arg1: int, arg2: int, arg3: float | int, arg4: int, *args):
    # 0x3E
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, float | int)
    assert isinstance(arg4, int)
    return _gScena.handleOpCode(0x3E, arg1, arg2, arg3, arg4, *args)

def OP_3F(arg1: uint16, arg2: uint32):
    # 0x3F
    assert isinstance(arg1, uint16)
...
def OP_41(arg1: int, arg2: int, *args):
    ...
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    return _gScena.handleOpCode(0x41, arg1, arg2, *args)
...
def OP_4A(arg1: uint8, arg2: float32, arg3: float32, arg4: float32, arg5: float32, arg6: uint32, arg7: uint8):
    ...
    assert isinstance(arg6, uint32)
    assert isinstance(arg7, uint8)
    _gScena.handleOpCode(0x4A, arg1, arg2, arg3, arg4, arg5, arg6, arg7)
...
def OP_4E(arg1: float32, arg2: float32, arg3: uint8, arg4: uint8):
    # 0x4E
    assert isinstance(arg1, float32)
    assert isinstance(arg2, float32)
    assert isinstance(arg3, uint8)
    assert isinstance(arg4, uint8)
    _gScena.handleOpCode(0x4E, arg1, arg2, arg3, arg4)
...
def OP_50(arg1: tuple | list, arg2: str, arg3: uint32, arg4: uint8):
    # 0x50
    assert isinstance(arg1, tuple | list)
    assert isinstance(arg2, str)
    assert isinstance(arg3, uint32)
    assert isinstance(arg4, uint8)
    _gScena.handleOpCode(0x50, arg1, arg2, arg3, arg4)
...
def OP_5A(arg1: int, *args):
    # 0x5A
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0x5A, arg1, *args)
...
def OP_61(arg1: int, *args):
    # 0x61
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0x61, arg1, *args)

def OP_62(arg1: uint16, arg2: uint16):
    # 0x62
    assert isinstance(arg1, uint16)
    assert isinstance(arg2, uint16)
    _gScena.handleOpCode(0x62, arg1, arg2)
...
def OP_64(arg1: int, *args):
    # 0x64
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0x64, arg1, *args)
...
def OP_6C(arg1: uint16, arg2: float32, arg3: uint32):
    # 0x6C
    assert isinstance(arg1, uint16)
    assert isinstance(arg2, float32)
    assert isinstance(arg3, uint32)
    _gScena.handleOpCode(0x6C, arg1, arg2, arg3)
...
def AddItem(arg1: int, *args):
    # 0x6F
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0x6F, arg1, *args)

def OP_6F(arg1: int, *args):
    # 0x6F
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0x6F, arg1, *args)
...
def OP_71(arg1: uint8, arg2: uint16, arg3: uint16):
    # 0x71
    assert isinstance(arg1, uint8)
    assert isinstance(arg2, uint16)
    assert isinstance(arg3, uint16)
...
def OP_78(arg1: int, arg2: str, *args):
    # 0x78
    assert isinstance(arg1, int)
    assert isinstance(arg2, str)
    return _gScena.handleOpCode(0x78, arg1, arg2, *args)
...
def OP_7D(arg1: uint16, arg2: uint32, arg3: float32):
    # 0x7D
    assert isinstance(arg1, uint16)
    assert isinstance(arg2, uint32)
    assert isinstance(arg3, float32)
    _gScena.handleOpCode(0x7D, arg1, arg2, arg3)
...
def OP_8E(arg1: uint16, arg2: uint16, arg3: uint16, arg4: uint16, arg5: uint16, arg6: uint16, arg7: uint16, arg8: uint16):
    # 0x8E
    assert isinstance(arg1, uint16)
    assert isinstance(arg2, uint16)
    assert isinstance(arg3, uint16)
    ...
    assert isinstance(arg7, uint16)
    assert isinstance(arg8, uint16)
    _gScena.handleOpCode(0x8E, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
...
def OP_96(arg1: int, *args):
    # 0x96
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0x96, arg1, *args)
...
def OP_99(arg1: uint16, arg2: uint16):
    # 0x99
    assert isinstance(arg1, uint16)
    assert isinstance(arg2, uint16)
    _gScena.handleOpCode(0x99, arg1, arg2)

def OP_9A(arg1: uint16, arg2: float32, arg3: float32, arg4: float32, arg5: uint16):
    # 0x9A
    assert isinstance(arg1, uint16)
    assert isinstance(arg2, float32)
    assert isinstance(arg3, float32)
    assert isinstance(arg4, float32)
    assert isinstance(arg5, uint16)
    _gScena.handleOpCode(0x9A, arg1, arg2, arg3, arg4, arg5)
...
def OP_A2(arg1: uint16, arg2: str, arg3: float32, arg4: float32):
    # 0xA2
    assert isinstance(arg1, uint16)
    assert isinstance(arg2, str)
    assert isinstance(arg3, float32)
    assert isinstance(arg4, float32)
    _gScena.handleOpCode(0xA2, arg1, arg2, arg3, arg4)
...
def OP_A5(arg1: int, arg2: int, *args):
    # 0xA5
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    return _gScena.handleOpCode(0xA5, arg1, arg2, *args)
...
def OP_B0(arg1: int, *args):
    # 0xB0
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xB0, arg1, *args)
...
def OP_B2(arg1: int, *args):
    # 0xB2
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xB2, arg1, *args)
...
def OP_B5(arg1: uint16, arg2: uint8, arg3: float32, arg4: float32, arg5: float32, arg6: uint16, arg7: uint16):
    # 0xB5
    assert isinstance(arg1, uint16)
    assert isinstance(arg2, uint8)
    assert isinstance(arg3, float32)
    ...
    assert isinstance(arg6, uint16)
    assert isinstance(arg7, uint16)
    _gScena.handleOpCode(0xB5, arg1, arg2, arg3, arg4, arg5, arg6, arg7)
...
def OP_BD(arg1: int, *args):
    # 0xBD
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xBD, arg1, *args)
...
def OP_C8(arg1: int, arg2: int, arg3: int, *args):
    # 0xC8
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, int)
    return _gScena.handleOpCode(0xC8, arg1, arg2, arg3, *args)
...
def OP_D0(arg1: int, *args):
    # 0xD0
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xD0, arg1, *args)

def OP_D1(arg1: int, *args):
    # 0xD1
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xD1, arg1, *args)

def OP_D2(arg1: int, *args):
    # 0xD2
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xD2, arg1, *args)

def OP_D3(arg1: int, *args):
    # 0xD3
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xD3, arg1, *args)

def OP_D4(arg1: int, *args):
    # 0xD4
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xD4, arg1, *args)

def OP_D5(arg1: int, *args):
    # 0xD5
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xD5, arg1, *args)

def OP_D6(arg1: uint16, arg2: tuple | list, arg3: tuple | list, arg4: tuple | list, arg5: tuple | list):
    # 0xD6
    assert isinstance(arg1, uint16)
    assert isinstance(arg2, tuple | list)
    assert isinstance(arg3, tuple | list)
    assert isinstance(arg4, tuple | list)
    assert isinstance(arg5, tuple | list)
    _gScena.handleOpCode(0xD6, arg1, arg2, arg3, arg4, arg5)

def AddBattleCount(arg1: uint8, arg2: uint32):
    # 0xD7
    assert isinstance(arg1, uint8)
    assert isinstance(arg2, uint32)
    _gScena.handleOpCode(0xD7, arg1, arg2)

def OP_D7(arg1: uint8, arg2: uint32):
    # 0xD7
    assert isinstance(arg1, uint8)
    assert isinstance(arg2, uint32)
    _gScena.handleOpCode(0xD7, arg1, arg2)
...
def OP_DA(arg1: int, *args):
    # 0xDA
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xDA, arg1, *args)

def OP_DB(arg1: uint8):
    # 0xDB
    assert isinstance(arg1, uint8)
    _gScena.handleOpCode(0xDB, arg1)

def OP_DC(arg1: int, *args):
    # 0xDC
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xDC, arg1, *args)

def OP_DE(arg1: int, *args):
    # 0xDE
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xDE, arg1, *args)

def OP_DF(arg1: uint32, arg2: uint8):
    # 0xDF
    assert isinstance(arg1, uint32)
    assert isinstance(arg2, uint8)
    _gScena.handleOpCode(0xDF, arg1, arg2)

def OP_E0(arg1: int, *args):
    # 0xE0
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xE0, arg1, *args)

def OP_E1(arg1: int, *args):
    # 0xE1
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xE1, arg1, *args)

def OP_E2(arg1: int, *args):
    # 0xE2
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xE2, arg1, *args)

def OP_E3(arg1: int, *args):
    # 0xE3
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xE3, arg1, *args)

def OP_E5(arg1: int, *args):
    # 0xE5
    assert isinstance(arg1, int)
    return _gScena.handleOpCode(0xE5, arg1, *args)

def OP_E6(arg1: uint16):
    # 0xE6
    assert isinstance(arg1, uint16)
