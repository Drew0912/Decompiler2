...
ScenaOpTable = ED83InstructionTable([
    ...
    inst(0x49,  'FormationCmd',                 NoOperand,                                      handler = Handler_49),
    ...
    inst(0x66,  'CraftCmd',                     NoOperand,                                      handler = Handler_66),
    ...
    inst(0x72,  'QuestCmd',                     NoOperand,                                      handler = Handler_72),
    ...
    inst(0x97,  'OP_97',                        'BWL'),
    inst(0x98,  'WeatherCmd',                   NoOperand,                                      handler = Handler_98),
    inst(0x99,  'OP_99',                        'W'),
